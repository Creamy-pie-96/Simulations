...
class GalaxyMapLevel : public Level
{
public:
    GalaxyMapLevel();
    ...
    LevelKind getKind() const override { return LevelKind::GalaxyMap; }
    std::string getTitle() const override { return "GALAXY MAP"; }
    float preferredZoom() const override { return 0.028f; }
